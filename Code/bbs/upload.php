...
<body>
    ...
    VALUES ('".$_POST['nickname']."','".$_POST['time']."','".$filename.".$ext"."','$target_file')";
                ...
                while($row=mysqli_fetch_array($res2)){
                    echo "<div> <a href='/Graduation_Project/bbs/download.php?filepath=".$row['changename']."&filename=".$row['realname']."'>".$row['realname']."</a><a style='float:right' href='/Graduation_Project/bbs/delete.php?filename=".$row['changename']."'>삭제</a></div><br>";
                }
            } else {
